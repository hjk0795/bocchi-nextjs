...
describe('Circle', () => {
    it('should mount', () => {
        ...
        cy.get('div').closest('.circle_circle__bK0F7').should('have.attr', 'style', 'width: 100px; height: 100px; line-height: 100px; border: 1px solid black; background-image: url("https://cdn-icons-png.flaticon.com/512/84/84042.png");');
    });
